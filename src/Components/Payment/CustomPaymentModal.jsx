            ...
            <>
              ...
              <div className="flex justify-between items-center px-4 py-3 border-b border-gray-200">
                <div className="flex items-center space-x-2">
                  ...
                  <h2 className="text-lg md:text-xl font-bold">Tim's Kitchen Cart Checkout</h2>
                </div>
                <button 
                ...
                <div className="w-full md:w-2/3 p-4 border-b md:border-b-0 md:border-r border-gray-200">
                  <div className="mb-4">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-base font-medium text-gray-800">NGN {amount}</p>
                      <button
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="flex items-center justify-between bg-gray-50 p-2 rounded">
                        <p className="text-sm font-semibold text-gray-700">NGN {bankDetails.amount}</p>
                        <button
                          onClick={() => copyToClipboard(`NGN ${bankDetails.amount}`, 'Amount')}
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between bg-gray-50 p-2 rounded">
                        <p className="text-sm font-mono font-bold">{bankDetails.accountNumber}</p>
                        <button
                    ...
                    <div>
                      ...
                      <div className="flex items-center justify-between bg-gray-50 p-2 rounded">
                        ...
                        <button
                          onClick={() => copyToClipboard(bankDetails.accountName, 'Beneficiary')}
                          className="text-blue-600 text-xs flex items-center"
                        >
                          <FaCopy className="mr-1" /> Copy
                        </button>
                  ...
                  <p className="text-xs text-gray-500 mt-4">
                    This account detail will expire soon and can only be used for this transaction.
                  </p>
                  ...
                  >
                    <FaCheckCircle className="mr-2" /> I have made this bank transfer
                  </button>
                </div>
                
                {/* Right Side: Payment Options */}
                <div className="w-full md:w-1/3 p-4">
                  <h3 className="text-sm text-gray-500 mb-2">Payment Options</h3>
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      <input 
                        ...
                        disabled
                      />
                      <label htmlFor="card" className="text-gray-700 text-sm">Card</label>
                    </li>
                    <li className="flex items-center">
                      <input 
                        type="radio" 
                        ...
                        disabled
                      />
                      <label htmlFor="usd" className="text-gray-700 text-sm">Whatsapp</label>
                    </li>
                    <li className="flex items-center">
                      <input 
                        type="radio" 
            ...
            <>
              ...
              <div className="p-6 flex flex-col items-center justify-center text-center space-y-4">
                <p className="text-sm md:text-base font-medium text-gray-700">
                  We are confirming your transfer. This could take about 4mins 58secs. 
                ...
                <div className="flex space-x-8 my-4">
                  <div className="text-center">
                    ...
                    <p className="font-mono font-bold text-sm flex items-center justify-center">
                      <FaClock className="mr-1 text-gray-600" /> {formatTimeElapsed()}
                    </p>
                  </div>
                  <div className="text-center">
                ...
                <p className="text-xs text-gray-500">Need help with the transaction?</p>
              </div>

              {/* Footer */}
              <div className="px-4 py-3 border-t border-gray-200 flex items-center justify-between">
                <p className="text-xs text-gray-400">Secured by ETech</p>
                <p className="text-xs text-gray-500">Order Reference: {orderReference}</p>
              </div>
            </>
          )}
