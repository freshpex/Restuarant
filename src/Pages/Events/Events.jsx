...
const upcomingEvents = [
  {
    ...
    description:
      "Join our executive chef for an immersive masterclass on traditional Nigerian cuisine. Learn the secrets behind classic dishes and modern interpretations.",
    image:
  ...
  },
  {
    ...
    description:
      "A celebration of Edo State's rich culinary heritage. Sample a variety of dishes from different regions, enjoy live cooking demonstrations, and participate in food competitions.",
    image:
  ...
  },
  {
    ...
    location: "Tim's Kitchen HQ, Emaudo Campus",
    description:
      "Learn how to prepare nutritious and delicious meals on a student budget. Perfect for those looking to maintain a healthy lifestyle while at university.",
    image:
...
const pastEvents = [
  {
    ...
    highlights:
      "A celebration of flavors from across the continent. Featured dishes from Nigeria, Ghana, Kenya and South Africa.",
  },
  {
    id: 102,
    ...
    image:
      "https://images.unsplash.com/photo-1577219491135-ce391730fb2c?q=80&w=2077&auto=format&fit=crop",
    highlights:
      "Students competed to create innovative dishes using limited ingredients. The winner received a scholarship and internship opportunity.",
  },
  {
    id: 103,
    ...
    image:
      "https://images.unsplash.com/photo-1608877907149-a206d75ba011?q=80&w=1974&auto=format&fit=crop",
    highlights:
      "Annual charity event providing meals to 500+ families in the community during the holiday season.",
  },
];
    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-lg border border-gray-200">
      <div className="md:flex">
        ...
        <div className="md:w-2/3 p-6">
          ...
          <div
            className={`transition-all duration-300 overflow-hidden ${showDetails ? "max-h-[1000px]" : "max-h-20"}`}
          >
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Join us for culinary events, workshops, and food festivals at Tim's Kitchen."
        />
      </Helmet>
      ...
      <div className="bg-[#121212] relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="text-center relative z-20">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Join us for culinary experiences, workshops, and food festivals
            throughout the year.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-white/90 mb-8">
              Tim's Kitchen offers catering services and venue rental for
              private events, celebrations, and corporate functions. Our team
              will work with you to create the perfect culinary experience for
              your guests.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="mt-4 text-xs text-gray-500">
              By subscribing, you agree to receive emails from Tim's Kitchen.
