...
import { FaWhatsapp, FaEnvelope, FaPhone, FaMapMarkerAlt, FaComment } from 'react-icons/fa';
...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast('Failed to send message. Please try again or use another contact method.', 'error');
    } finally {
      setIsSending(false);
    }
  };
  ...
  const openWhatsApp = () => {
    window.open('https://wa.me/+2349041801170?text=Hello%20Tim%27s%20Kitchen,%20I%20would%20like%20to%20inquire%20about', '_blank');
  };

  const sendEmail = () => {
    window.location.href = 'mailto:timskitchen@tidioxyz?subject=Inquiry%20for%20Tim%27s%20Kitchen';
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Get in touch with Tim's Kitchen for inquiries, feedback, or to place a special order." />
      </Helmet>
      ...
      <div className="bg-[#121212] relative h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="text-center relative z-20">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            We'd love to hear from you. Reach out to us with questions, feedback, or to place an order.
          </p>
        </div>
      </div>
            ...
            <div className="col-span-1 bg-gray-50 p-8 rounded-lg shadow-md">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-gray-700">Send Email</h3>
                    <button 
                      onClick={sendEmail}
      ...
      <div className="fixed bottom-6 right-6 z-50">
        ...
        {isLiveChatOpen && (
          <div className="absolute bottom-16 right-0 w-80 bg-white rounded-lg shadow-xl border border-gray-200 overflow-hidden">
            ...
            <div className="p-4">
              <p className="text-gray-700 mb-4">Our live chat is currently under maintenance.</p>
              <p className="text-gray-700 mb-4">Please use WhatsApp or email for immediate assistance.</p>
