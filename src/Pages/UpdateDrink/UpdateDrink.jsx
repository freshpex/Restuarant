...
import {
  ...
  fetchDrinkForUpdate,
  clearDrinkForUpdate,
} from "../../redux/slices/drinkActionsSlice";
...
const UpdateDrink = () => {
  ...
  const { loading, error, success, drinkForUpdate } = useSelector(
    (state) => state.drinkActions,
  );
      ...
      dispatch(fetchDrinkForUpdate({ id, token }))
        ...
        .then((drink) => {
          if (drink.email !== user.email && isAdmin) {
            ...
            toast("You are editing this drink as an admin", {
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="bg-blue-50 border-b border-blue-100 px-6 py-8">
              ...
              <p className="text-center mt-2 text-gray-600">
                Make changes to your drink item information
              </p>
            </div>
            ...
            {isEditingAsAdmin && (
              <div className="bg-blue-50 px-6 py-3 border-b border-blue-100 flex items-center">
                ...
                <p className="text-blue-700 text-sm">
                  <span className="font-semibold">Admin Mode:</span> You are
                  editing content created by {drinkForUpdate.email}
                </p>
              </div>
            )}
                ...
                {isUsingUrl ? (
                  ...
                  <>
                    ...
                    <p className="mt-1 text-xs text-gray-500">
                      Choose a new image file to update the current image.
                    </p>
                  </>
                )}
                ...
                {isSubmitting && (
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-center mt-1 text-gray-500">
                      {imageFile
                        ? "Uploading image and updating drink..."
                        : "Updating drink..."}
                    </p>
                  </div>
                )}
