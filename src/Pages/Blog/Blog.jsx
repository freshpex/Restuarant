...
const blogPosts = [
  {
    ...
    excerpt:
      "Discover the authentic techniques and ingredients that make Nigerian Jollof Rice stand out from other variants in West Africa.",
    content: `
    ...
    image:
      "https://images.unsplash.com/photo-1634482899180-13304dbd3a86?q=80&w=2070&auto=format&fit=crop",
    featured: true,
  },
  {
    id: 2,
    ...
    excerpt:
      "How we're working with local farmers to bring the freshest ingredients to your plate while supporting sustainable farming practices.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "Delve into the vibrant world of Nigerian spices and learn how they not only enhance flavor but also offer remarkable health benefits.",
    content: `
    ...
    category: "Health",
    image:
      "https://images.unsplash.com/photo-1532336414791-78b61a6bb707?q=80&w=2070&auto=format&fit=crop",
  },
  {
    id: 4,
    title: "The Art of Nigerian Soups: Beyond Egusi and Okra",
    excerpt:
      "Exploring the diverse world of Nigerian soups that don't always get international recognition but deserve a place on your dining table.",
    content: `
    ...
    category: "Nigerian Cuisine",
    image:
      "https://images.unsplash.com/photo-1583608564370-0cac947b4aeb?q=80&w=1970&auto=format&fit=crop",
  },
  {
    id: 5,
    title: "Campus Cooking 101: Nutritious Meals on a Student Budget",
    excerpt:
      "Practical advice for university students looking to eat healthy without breaking the bank or sacrificing study time.",
    content: `
  ...
  },
  {
    ...
    excerpt:
      "How traditional street food is adapting to meet the tastes and needs of today's university students.",
    content: `
...
const Blog = () => {
  ...
  const handleSubscribe = (e) => {
    e.preventDefault();
    toast.success(
      `Thank you for subscribing! We've sent a confirmation to ${subscriberEmail}.`,
    );
    setSubscriberEmail("");
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Read our latest articles on Nigerian cuisine, health benefits of local ingredients, sustainable food practices, and campus cooking tips."
        />
      </Helmet>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-600 mb-6">
              Stay updated with our latest recipes, cooking tips, and food
