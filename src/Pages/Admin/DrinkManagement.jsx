...
const DrinkManagement = () => {
  ...
  const fetchDrinks = async () => {
    try {
      ...
      const uniqueCategories = [
        ...new Set(data.drinks.map((drink) => drink.drinkCategory)),
      ];
  ...
  const handleDelete = async (id) => {
    if (!window.confirm("Are you sure you want to delete this drink item?"))
      return;
                    ...
                    currentItems.map((drink) => {
                      ...
                      return (
                        <tr key={drink._id}>
                          ...
                          <td className="px-6 py-4">
                            <span
                              className={`px-2 inline-flex items-center text-xs leading-5 font-semibold rounded-full ${stockStatus.color}`}
                            >
                        ...
                        <div className="flex-1">
                          ...
                          <div className="flex justify-between items-center mt-1">
                            <p className="text-xs text-gray-500">
                              Orders: {drink.orderCount || 0}
                            </p>
                            <span
                              className={`px-2 py-1 text-xs font-semibold rounded-full flex items-center ${stockStatus.color}`}
                            >
                              {stockStatus.status !== "normal" && (
                                <FaExclamationTriangle className="mr-1" />
                              )}
