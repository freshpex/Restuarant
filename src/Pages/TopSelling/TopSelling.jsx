...
const TopSelling = () => {
  ...
  const { loading: foodsLoading, error: foodsError } = useSelector(
    (state) => state.foodActions,
  );
  const { loading: drinksLoading, error: drinksError } = useSelector(
      ...
      <div className="bg-gradient-to-b from-[#121212] to-[#1a1a1a] lg:px-28 px-6 pt-44 pb-20">
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          <p className="text-gray-300 max-w-2xl text-center">
            Our most popular dishes loved by customers. Try these fan favorites
            today!
          </p>
        </div>
        ...
        <div className="my-24 flex items-center">
          ...
          <div className="px-4 text-yellow-500">
            <span className="px-3 py-1 border border-yellow-500 rounded-full">
              AND
            </span>
          </div>
          <div className="flex-1 h-0.5 bg-gray-700"></div>
        ...
        <div className="flex flex-col items-center mb-16">
          ...
          <div className="h-1 w-24 bg-yellow-600 rounded mb-6"></div>
          <p className="text-gray-300 max-w-2xl text-center">
            Refreshing beverages our customers can't get enough of. Perfect
