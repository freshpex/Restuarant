            ...
            <>
              ...
              >
                <div>
                  ...
                  >
                    <div className="w-16 ring-2  cursor-pointer   rounded-full">
                      <img src={user.photoURL} />
                    </div>
                  </div>
        ...
        >
          <div className=" flex flex-col justify-center items-center pt-6 pb-4">
            {isAuthenticated && user?.email && (
              <>
                <div className="avatar">
                  <div className="w-14 cursor-pointer rounded-full ring-2 ring-yellow-400">
                    <img src={user?.photoURL} />
                  </div>
                </div>
                <div>
            ...
            {isAuthenticated && (
              <ul className=" py-1 space-y-3">
                {isStaff && (
                  <li className="text-center border-2 border-white w-full hover:border-2 hover:border-yellow-700 py-3 px-3 rounded-md">
                    {" "}
                    <Link to="/myFood" onClick={() => setNav(false)}>
                      My Added Food Items
                    </Link>
                  </li>
                )}
                <li className="text-center border-2 border-white w-full hover:border-2 hover:border-yellow-700 py-3 px-3 rounded-md">
                  {" "}
                  <Link to="/orderFood" onClick={() => setNav(false)}>
