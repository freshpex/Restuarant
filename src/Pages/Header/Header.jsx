          ...
          {isAuthenticated && user?.email ? (
            <>
              ...
              >
                <div>
                  <div
                    className={`avatar ${avatar ? "flex  justify-center items-center" : "hidden"} pb-2`}
                  >
                    <div className="w-16 ring-2 ring-yellow-400  cursor-pointer   rounded-full">
                      <img src={user.photoURL} />
                    </div>
                  </div>
                  <h2 className=" pt-3 pb-2 text-md text-center font-semibold  text-gray-800 dark:text-gray-400">
                    Name : {user.displayName}
                  </h2>
                  <h2 className=" text-md text-center font-semibold pb-4  text-gray-800 dark:text-gray-400">
                    Email : {user.email}
                  </h2>
                  {user.email === "adminsafin@gmail.com" && (
                    <button className="  text-lg border-2 border-gray-100 hover:border-2 hover:bg-indigo-700 hover:border-indigo-700 mb-3 text-indigo-700 hover:text-white  rounded-md py-2 px-4">
                      {user.email === "adminsafin@gmail.com" && (
        ...
        >
          <div className=" flex flex-col justify-center items-center pt-6 pb-4">
            {isAuthenticated && user?.email && (
              <>
                <div className="avatar">
                  <div className="w-12 cursor-pointer rounded-full ring-2 ring-yellow-400">
                    <img src={user?.photoURL} />
                  </div>
                </div>
                <div>
                  <h2 className=" text-sm text-center font-semibold text-gray-800 dark:text-gray-400 pb-2 pt-4 ">
                    Name : {user.displayName}
                  </h2>
                  <h2 className=" text-sm  text-center font-semibold  text-gray-800 dark:text-gray-400 pb-4">
                    Email : {user.email}
                  </h2>
                  {user.email === "adminsafin@gmail.com" && (
                    <button className="  text-lg border-2 border-gray-100 hover:border-2 hover:bg-indigo-700 hover:border-indigo-700 mb-3 text-indigo-700 hover:text-white  rounded-md py-2 px-4">
