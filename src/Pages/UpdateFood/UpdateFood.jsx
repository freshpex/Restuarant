...
const UpdateFood = () => {
  ...
  const { loading, error, success, foodForUpdate } = useSelector(
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="bg-yellow-50 border-b border-yellow-100 px-6 py-8">
              ...
              <p className="text-center mt-2 text-gray-600">
                Make changes to your food item information
              </p>
            </div>
            ...
            {isEditingAsAdmin && (
              <div className="bg-blue-50 px-6 py-3 border-b border-blue-100 flex items-center">
                ...
                <p className="text-blue-700 text-sm">
                  ...
                  editing content created by {foodForUpdate.email}
                </p>
              </div>
            )}
                    ...
                    <div className="flex flex-col items-center justify-center w-full">
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        {previewUrl
                          ...
                          : "Upload a new image for this food item"}
                      </p>
                    </div>
                  )}
                </div>
              ...
              {isSubmitting && (
                <div className="mt-6">
                  ...
                  <p className="text-center text-xs text-gray-500 mt-2">
                    {imageFile
                      ? "Uploading your new image and updating..."
