...
const AddFood = () => {
  ...
  const handleAddFood = async (e) => {
    ...
    try {
      await dispatch(
        addFood({ foodData, token, imageFile: isUsingUrl ? null : imageFile }),
      ).unwrap();
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden transition-all duration-300 hover:shadow-2xl">
            ...
            <div className="bg-yellow-50 border-b border-yellow-100 px-6 py-8">
              ...
              <p className="text-center mt-2 text-gray-600">
                Enter the details below to add a new food item to the menu
              </p>
            </div>
              ...
              {isSubmitting && (
                <div className="mt-6">
                  ...
                  <p className="text-center text-xs text-gray-500 mt-2">
                    Please wait while we upload your food image and save the
                    information...
                  </p>
                </div>
              )}
