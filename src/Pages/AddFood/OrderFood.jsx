...
import {
  ...
  deleteOrder,
  updatePaymentStatus,
} from "../../redux/slices/foodActionsSlice";
...
const OrderFood = () => {
  ...
  const handlePayOnline = () => {
    ...
    const totalPrice =
      currentOrder.totalPrice || (unitPrice * quantity).toFixed(2);
        ...
        callback: async (response) => {
          ...
          if (
            ...
            try {
              ...
              toast.error(
                "Payment was recorded but there was an issue updating your order.",
              );
            }
          } else {
        ...
        <>
          ...
          {orders.length > 0 ? (
            <div className="bg-[#121212] lg:px-28 px-6 pt-10 pb-44 flex flex-col gap-8 justify-center items-center">
              {orders.map((data) => (
                <div
                  className="card sm:card-side w-full lg:w-[800px] bg-base-100"
                  key={data._id}
                >
                  <figure>
                    <img
                  ...
                  <div className="card-body">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <h2 className="">
                        Delivery to:{" "}
                        {capitalizeWords(
                          data.deliveryLocation || "Not specified",
                        )}
                      </h2>
                      <h2 className="text-sm text-gray-600">
                        Address: {data.fullAddress || "Not provided"}
                      </h2>
                      <div className="flex justify-between">
                        <span>
                          ...
                          {formatPrice(
                            data.itemsSubtotal ||
                              data.foodPrice * data.quantity,
                          )}
                        </span>
                        <span>
                          Delivery: {formatPrice(data.deliveryFee || 0)}
                        </span>
                      </div>
                      <h3 className="mt-1">
