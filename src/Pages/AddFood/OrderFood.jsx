    ...
    return (
        <>
            ...
            {orders.map(data => {
                ...
                {/* <span className="bg-blue-200 text-blue-800 text-base font-semibold  px-3 py-2 flex justify-start flex-row w-[180px]  mb-2 mt-2 text-center rounded  dark:text-blue-800 ">Rating : {data.rating}.0 / 10.0</span> */}
