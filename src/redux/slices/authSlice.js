    ...
    try {
      ...
      if (profileImage) {
        try {
          ...
          console.warn(
            "Profile image upload failed, but continuing registration:",
            uploadError,
          );
      ...
      try {
        ...
        console.warn(
          "User sync failed but registration will proceed:",
          syncError,
        );
      }
      ...
      return rejectWithValue(error.message || "Could not register user");
    }
  },
);
...
export const logoutUser = createAsyncThunk(
  ...
  async (_, { rejectWithValue }) => {
    try {
      ...
      return rejectWithValue(error.message || "Could not log out");
    }
  },
);
