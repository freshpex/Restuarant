...
const SignIn = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Tim's Kitchen | Sign In</title>
      </Helmet>
      <Header2 />
          ...
          <Card className="w-96">
            ...
            <CardFooter className="pt-0">
              ...
              <button
                ...
                className="tracking-wider font-bold py-2 border-2 border-white hover:border-2 hover:border-gray-900 w-full rounded-lg mt-3"
                type="submit"
              >
                SIGN WITH GOOGLE
              </button>
